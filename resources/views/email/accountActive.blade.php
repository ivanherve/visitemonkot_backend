...
<html lang="fr">
    <head>
        ...
        <script>
            ...
            var mainContent =
                "<p>Cher/Chère {{$user}}</p>" +
                "<p>Votre inscription est maintenant finalisé et votre compte est activé.</p>" +
                "<p>Vous pouvez maintenant annoncer des logements ou prévoir des visites. <a href='https://visitemonkot.be'>Cliquez ici</a></p>";
