...
<html lang="fr">
    <head>
        ...
        <script>
            moment.locale('fr');
            var date = '<u>'+moment("{{$dateVisit}}").format('Do MMMM YYYY')+'</u>'+' à <u>'+moment("{{$dateVisit}}").format('h:mm')+'</u>';
            var mainContent;
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#e0fff5">
                ...
                Item --><div class="mob_center_bl" style="float: right; display: inline-block; width: 88px;">
                    ...
                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
                        Vous avez une demande de visite
                    </span></font>
                                            </div>
                    ...
                    <span id="main" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                        <p>Cher/Chère {{$ownerName}} {{$ownerSurname}},</p>
                        <p>{{$visiterName}} {{$visiterSurname}} aimerait visiter <b>{{$accomodation}}</b> le {{$dateVisit}} </p>
                        <p>Nous vous invitons alors à consulter les visites à venir de {{$accomodation}} pour confirmer la demande de visite</p>
                    </span></font>
                                            </div>
                                    ...
                                    <tr><td align="center">
                                            <div style="line-height: 24px; width: 50%" class='row'>
                                                {{--<div class='col'><a href="http://google.com" style='width: 100%' class='btn btn-success'>Confirmer</a></div>--}}
                                                {{--<div class='col'><a href="http://google.com" style='width: 100%' class='btn btn-danger'>Refuser</a></div>--}}
                                            </div>
