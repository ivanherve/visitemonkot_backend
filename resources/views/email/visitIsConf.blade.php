    ...
    <head>
        ...
        <script>
            ...
            var mainContent =
                ...
                "<p>{{$owner}} a accepté votre demande de visite</p>" +
                "<table class='table'>" +
                    "<tr>" +
                        "<td>Adresse : </td>" +
                        "<td>{{$address}}</td>" +
                ...
                "</table>" +
                "<p>" +
                "Toutes modifications ou annulation de visite sur le site <a href='https://visitemonkot.be'>visitemonkot.be</a>" +
                "</p>";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#e0fff5">
                ...
                Item --><div class="mob_center_bl" style="float: right; display: inline-block; width: 88px;">
                    ...
                    <span id="main" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                    ...
                                    <tr><td align="center">
                                            <div style="line-height: 24px; width: 50%">
